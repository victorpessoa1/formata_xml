                ...
                const xmlSeloFormatado = new XmlSeloDTO(
                  {
                    ...
                    AtoPraticado:{
                      ...
                      NaturezaAto: atoPraticado.NaturezaAto[0],
                      ...
                      CodigoSeguranca: atoPraticado.SelosAto[0].CodigoSeguranca[0],
                      },
                      PessoasAto:{
                        SequencialAto: atoPraticado.PessoasAto[0].SequencialAto[0],
                        NumeroDocumento: atoPraticado.PessoasAto[0].NumeroDocumento[0],
                        TipoDocumento: atoPraticado.PessoasAto[0].TipoDocumento[0],
                        TipoParticipacao: atoPraticado.PessoasAto[0].TipoParticipacao[0],
