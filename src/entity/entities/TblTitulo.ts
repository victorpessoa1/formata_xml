...
@Index("apLivro", ["apLivro"], {})
@Index("Baixado", ["baixado"], {})
@Index("Cad_Retorno", ["cadRetorno"], {})
@Index("Data_Apresenta", ["dataApresenta"], {})
@Index("Data_Cancelado", ["dataCancelado"], {})
@Index("Data_Ocorrencia", ["dataOcorrencia"], {})
@Index("Data_Pagamento", ["dataPagamento"], {})
@Index("Data_Protestado", ["dataProtestado"], {})
@Index("Data_Retirada", ["dataRetirada"], {})
@Index("Data_Retorno", ["dataRetorno"], {})
@Index("DataEditado", ["dataEditado"], {})
@Index("dEdital", ["dEdital"], {})
@Index("Devedor", ["devedor"], {})
@Index("Edital", ["edital"], {})
@Index("idProtocolo", ["idProtocolo"], { unique: true })
@Index("index_910626287", ["rowguid"], { unique: true })
@Index("Marca", ["marca"], {})
@Index("N_Edital", ["nEdital"], {})
@Index("Num_Devedor", ["numDevedor"], {})
@Index("Protocolo", ["protocoloCartorio"], { unique: true })
@Index("Protocolo_Dist", ["protocoloDist"], {})
@Index("RetCenprot", ["retCenprot"], {})
@Index("Tipo_Ocorrencia", ["tipoOcorrencia"], {})
@Index("V_Selo", ["vSelo"], {})
@Index("Valor_Custas", ["valorCustas"], {})
@Index("Valor_Distrib", ["valorDistrib"], {})
@Entity("tblTitulo", { schema: "dbo" })
export class TblTitulo {
