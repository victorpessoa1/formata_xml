...
@Index("PK_tblSeloEdital", ["idProtocolo"], { unique: true })
@Entity("tblSeloEdital", { schema: "dbo" })
export class TblSeloEdital {
  ...
  @Column("int", { name: "CodPortador", nullable: true })
  codPortador: number | null;
